...
function initializeGame(){
    ...
    let input=1;
    var headposition= {'x':Math.floor(Math.floor(size/2))+2,'y':Math.floor(Math.floor(size/2))};
    ...
    function fps(ctime){
        ...
        if (snakeArr[0].x<0 || snakeArr[0].x>size-1 || snakeArr[0].y<0 || snakeArr[0].y>size-1){
            ...
            if (lives!=0){
                ...
                headposition= {'x':Math.floor(size/2)+2,'y':Math.floor(size/2)};
        ...
        seg.forEach(s=>{
            if (snakeArr.length>4){
                ...
                if (lives==0){
                    ...
                    headposition= {'x':Math.floor(size/2)+2,'y':Math.floor(size/2)};
                    bodyposition= {'x':Math.floor(size/2)+1,'y':Math.floor(size/2)};
                    snakeArr=[headposition,bodyposition,{'x':Math.floor(size/2),'y':Math.floor(size/2)}];
                    snakeArr.forEach(s=>{
